 ...
 *         &lt;element name="notation" type="{http://www.ringingmaster.org.uk/touch/v1}touchNotationType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="nonSplicedActiveNotation" type="{http://www.ringingmaster.org.uk/touch/v1}notationKeyType" minOccurs="0"/>
...
public class TouchType {
    ...
    protected List<TouchNotationType> notation;
    protected NotationKeyType nonSplicedActiveNotation;
     ...
     * {@link TouchNotationType }
     * 
     * 
     */
    public List<TouchNotationType> getNotation() {
        if (notation == null) {
            notation = new ArrayList<TouchNotationType>();
        }
     ...
     * @return
     *     possible object is
     *     {@link NotationKeyType }
     *     
     */
    public NotationKeyType getNonSplicedActiveNotation() {
     ...
     *     
     */
    public void setNonSplicedActiveNotation(NotationKeyType value) {
